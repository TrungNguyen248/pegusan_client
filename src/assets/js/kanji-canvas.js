	...
	*/
    ...
    KanjiCanvas.redraw = function (id) {
        ...
        if (KanjiCanvas['canvas_' + id].dataset.strokeNumbers != 'false') {
            for (
                var i = 0;
                i < KanjiCanvas['recordedPattern_' + id].length;
                i++
            ) {
                var stroke_i = KanjiCanvas['recordedPattern_' + id][i],
                ...
                KanjiCanvas['ctx_' + id].strokeStyle = KanjiCanvas.alterHex(
                    KanjiCanvas.strokeColors[i]
                        ? KanjiCanvas.strokeColors[i]
                        : '#333333',
                    60,
                    'dec',
                ...
                // fill
                KanjiCanvas['ctx_' + id].fillStyle = KanjiCanvas.strokeColors[i]
                    ? KanjiCanvas.strokeColors[i]
                    : '#333'
