...
var KanjivgAnimate = (function () {
        ...
        return (
            (t.prototype.setOnClick = function (t, e) {
                for (
                    var i = document.querySelectorAll(t), n = i.length, s = 0;
                    n > s;
                    s++
                )
            ...
            (t.prototype.play = function (t) {
                ...
                if (
                    ...
                    ;(this.paths = e.querySelectorAll('path')),
                        ...
                        this.hideAll(),
                        (this.count = 0)
                    var i = this.paths[this.count],
                        n = this.numbers[this.count]
            ...
            (t.prototype.hideAll = function () {
                for (var t = 0; t < this.pathCount; t++)
                    (this.paths[t].style.display = 'none'),
                        'undefined' != typeof this.numbers[t] &&
                            (this.numbers[t].style.display = 'none')
            }),
            (t.prototype.animatePath = function (t, e) {
                ;(this.length = t.getTotalLength()),
                    (t.style.display = 'block'),
                    'undefined' != typeof e && (e.style.display = 'block'),
                    (t.style.transition = t.style.WebkitTransition = 'none'),
                    (t.style.strokeDasharray = this.length + ' ' + this.length),
                    (t.style.strokeDashoffset = this.length),
