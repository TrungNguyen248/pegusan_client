...
<template>
    <div class="bg-[#FFF7F1] top-0 left-0">
        <Notification />
        <Header class="fixed top-0">
            ...
            <template #menu>
                <div class="hidden lg:block">
                    <ul
                        class="flex *:mx-4 *:p-4 *:font-bold *:h-full *:text-[#DAC0A3] *:hover:*:text-white"
                    >
                        <router-link to="/course"
                            ><li>Khóa học</li></router-link
                        >
                        <router-link to="/grammar"
                            ><li>Ngữ pháp</li></router-link
                        >
                        <router-link to="/kanji"><li>Kanji</li></router-link>
                        <router-link to="/exams"><li>Test</li></router-link>
                        <router-link to="/dict"><li>Tra từ</li></router-link>
                    </ul>
                </div>
            </template>
            <template #profile>
                <div class="flex items-center">
                    <div class="mr-5">
                        <BellIcon class="w-7 h-[28px]" />
                    </div>
                    <div
                        class="relative flex cursor-pointer items-center"
                        @click="showMenu()"
                    >
                        <div class="relative h-[56px] w-14 select-none">
                            <img
                                class="h-12 w-12 rounded-full border-2 border-[#EADBC8]"
                            ...
                            />
                            <div
                                class="absolute bottom-0 right-0 flex items-center justify-center rounded-full w-[26px] h-[24px] px-1 py-1 bg-[#102C57] border-2 border-[#FEFAF6]"
                            >
                        ...
                        <div class="p-3 font-semibold">
                            <p class="text-sm text-white select-none">
                                {{ user?.name }}
                            </p>
                        </div>
                        <div
                            v-if="isShowMenu"
                            class="absolute top-[72px] right-0 max-w-[300px] w-[240px] bg-white border-2 border-black rounded-2xl overflow-hidden"
                        >
                            <div class="z-50">
                                <ul>
                                    <router-link to="/profile" class="mb-2"
                                        ><li
                                            class="px-4 py-3 hover:bg-[#FFE4C9] font-medium transition-all hover:transition-all"
                                        >
                                            Thông tin tài khoản
                                        </li></router-link
                                    >
                                    <router-link to="/review" class="mb-2"
                                        ><li
                                            class="px-4 py-3 hover:bg-[#FFE4C9] font-medium transition-all hover:transition-all"
                                        >
                                            Thư mục ôn tập
                                    ...
                                    <li
                                        @click="logout()"
                                        class="px-4 py-3 hover:bg-[#FFE4C9] font-medium transition-all hover:transition-all text-red-500"
                                    >
                                        Đăng xuất
                                    </li>
                                </ul>
