        ...
        <Header class="fixed top-0 border-b-[1px] border-[#153448]">
            ...
            <template #menu>
                <div class="hidden lg:block">
                    <ul
                        class="flex *:mx-4 *:p-4 *:font-bold *:h-full *:text-white *:hover:*:text-white"
                    >
            ...
            <template #profile>
                ...
                >
                    <div class="relative h-[56px] w-14 select-none">
                        ...
                        />
                        <div
                            class="absolute bottom-0 right-0 flex items-center justify-center rounded-full w-[26px] h-[24px] px-1 py-1 bg-black"
                        >
                    ...
                    <div class="p-3 font-semibold">
                        <p class="text-sm text-[#dfd0b8] select-none">
                            {{ user?.name }}
                        </p>
                    </div>
                    <div
                        v-if="isShowMenu"
                        class="absolute top-[72px] right-0 max-w-[300px] w-[240px] bg-white rounded-2xl overflow-hidden"
                    >
                        <div class="z-50">
                            <ul>
                                <router-link to="/profile" class="mb-2"
                                    ><li
                                        class="px-4 py-3 hover:bg-gray-300/40 font-medium transition-all hover:transition-all"
                                    >
                                        Thông tin tài khoản
                                    </li></router-link
                                >
                                ...
                                <li
                                    @click="logout()"
                                    class="px-4 py-3 hover:bg-gray-300/40 font-medium transition-all hover:transition-all text-red-500"
                                >
                                    Đăng xuất
                                </li>
                            </ul>
