...
<template>
    <div class="container mx-auto max-w-7xl mt-[72px]">
        ...
        <div class="p-4 sm:p-10 flex flex-col items-center w-full">
            <div class="w-full sm:w-[800px] max-w-4xl">
                <div class="flex flex-col sm:flex-row">
                    <div
                        class="flex justify-center p-5 w-full sm:w-60 h-[240px]"
                    >
                        <img
                            class="rounded-full"
                    ...
                    >
                        <div class="mb-4">
                            ...
                            <div class="relative px-4">
                                ...
                                >
                                    <div
                                        class="h-[20px] bg-gradient-to-r from-[#9fcf7b] to-[#3fa879] transition-all"
                                        :style="{
                        ...
                        <div class="flex justify-end py-2">
                            <button
                                class="cursor-pointer transition-all hover:transition-all border-2 border-[#e8c9af] hover:border-white hover:bg-[#153448] hover:text-white text-[#153448] font-bold py-2 px-4 rounded-full bg-[#e8c9af]"
                            >
                                Cập nhật
                            </button>
                        </div>
            ...
            <div class="w-full max-w-7xl">
                <div class="flex flex-wrap justify-center sm:justify-normal">
                    <div
                        ...
                        :class="
                            course.course != null
                                ? 'relative xl:w-1/3 w-full md:w-1/2 p-4 flex flex-col rounded-2xl'
                                : 'hidden'
                        "
                    >
                        <router-link
